...
namespace Lab2.ML.Models
{
    class CancerModel
    {
        ...
        public float Survival_fromMDM { get; set; }
        ...
        public float Time_diagnosis_1st_Tx { get; set; }
        public string Date_incident_surveillance_scan { get; set; }
        public string PS { get; set; }
        public float Time_MDM_1st_treatment { get; set; }
        public float Time_decisiontotreat_1st_treatment { get; set; }
        public string Prev_known_cirrhosis { get; set; }
        public float Months_from_last_surveillance { get; set; }
    }
}
